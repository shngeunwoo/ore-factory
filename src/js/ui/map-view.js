import { BALANCE, INGOT_IDS, ORE_LABEL, itemName, tutorialTileHint } from "../domain/recipes.js?v=36";
import { RAIL_DIRECTIONS } from "../game/buildings.js?v=36";
import { tileKey } from "../game/map.js?v=36";
