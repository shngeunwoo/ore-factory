import { BALANCE, INGOT_IDS, ORE_LABEL, itemName, tutorialTileHint } from "../domain/recipes.js?v=37";
import { RAIL_DIRECTIONS } from "../game/buildings.js?v=37";
import { tileKey } from "../game/map.js?v=37";
